                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Contra</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
							...
							<form name="receipt" id="receipt" autocomplete="off">
								<div class="welcome-wrapper shadow-reset res-mg-t mg-b-30">
									<div class="welcome-adminpro-title">
										<div class="row">
											<div class="col-md-6">
												<h1><span class="voucher-title">Contra</span> No: <span class="receipt_no"><?php echo $recp_prefix ."-". $receiptno; ?></span></h1>
											</div>
										...
										<div class="trns-details">
											<div class="row">
												<div class="col-md-8">
													...
													<input type="text" class="ledger-input" id="dr_ledger" name="ledger" /> 
													<input type="hidden" id="dr_ledger_id" name="dr_ledger_id" class="hidden_ledger"/>
												</div>
												<div class="col-md-2"><input type="text" class="amount-input dr_amnt" name="dr_amnt" /> </div>
							...
							<div class="sparkline8-list shadow-reset">
                                <div class="sparkline8-hd">
                                    <div class="main-sparkline8-hd">
                                        <h1>Listed Receipts</h1>
                                    </div>
                                </div>
                                <div class="sparkline8-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
										<table class="table table-borderless datatable" id="receiptlist">
											<thead>
												<tr>
													<th>No.</th>
													<th>Paid By</th>
